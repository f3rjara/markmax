...
- Prefer composition over inheritance for services that _use_ a repository (inject it); only the concrete implementation class should _extend_ the abstract repository.
